...
import com.ronnie.digifarm.repository.InventoryTransactionsRepository;
...
public class InventoryTransactionService {
    ...
    private final InventoryTransactionsRepository inv_transaction_repo;
        ...
        try{
            ...
            return switch ( action.toLowerCase()) {
                case "insert single" -> {
                    ...
                    inv_transaction_repo.save(single);
                ...
                case "insert many" -> {
                    ...
                    inv_transaction_repo.saveAll(body);
                ...
                case "get" -> {
                    List<InventoryTransactions> logs =    inv_transaction_repo.findAll();
